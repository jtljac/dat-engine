...
namespace DatEngine {
     ...
     */
    enum class CVarCategory : uint8_t { General, Graphics, Networking };
    ...
    enum class CVarFlags : uint16_t {
        ...
        /** Suggests that changes to the CVar will not be reflected until after a restart, force enables {@link
           Persistent} flag */
     ...
     *
     * Implementation can be found in {@link CVarSystemImpl}, which is declared in CVar.cpp to reduce the public
     * interface
     *
     * @see CVarSystemImpl
     */
    ...
    public:
         ...
         */
        virtual CVarParameter*
        createIntCVar(const char* name, const char* description, CVarCategory category, int32_t value) = 0;
        ...
        virtual CVarParameter* createIntCVar(
                const char* name, const char* description, CVarCategory category, int32_t initialValue, int32_t value
        ) = 0;
         ...
         */
        virtual CVarParameter*
        createBoolCVar(const char* name, const char* description, CVarCategory category, bool value) = 0;
         ...
         * @return A CVarParameter Representing the CVar
         */
        virtual CVarParameter* createBoolCVar(
                const char* name, const char* description, CVarCategory category, bool initialValue, bool value
        ) = 0;
         ...
         */
        virtual CVarParameter*
        createFloatCVar(const char* name, const char* description, CVarCategory category, double value) = 0;
        ...
        virtual CVarParameter* createFloatCVar(
                const char* name, const char* description, CVarCategory category, double initialValue, double value
        ) = 0;
         ...
         */
        virtual CVarParameter*
        createStringCVar(const char* name, const char* description, CVarCategory category, const char* value) = 0;
    ...
    struct CVarEnum : CVarInt {
         ...
         */
        T getEnum() { return static_cast<T>(CVarInt::get()); }

        /**
         * Get the default value stored in the CVar as the enum type
         * @return The default enum value stored in the CVar
         */
        T getDefaultEnum() { return static_cast<T>(CVarInt::getDefault()); }

        /**
         * Set the value of the CVar using the enum representation
         * @param value The new value of the CVar
         */
        void set(T value) { CVarInt::set(static_cast<int32_t>(value)); }

        /**
         * Reset the CVar value to its default and return the Enum representation
         * @return T The new enum value stored in the CVar
         */
        T resetEnum() { return static_cast<T>(CVarInt::reset()); }
    };
} // namespace DatEngine
