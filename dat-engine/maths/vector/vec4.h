 ...
 */
struct DatEngine::DatMaths::Vector<4, componentType> {
    ...
    explicit Vector(const Vector<1, otherType>& otherVec) :
        x(static_cast<componentType>(otherVec.x)), y(0), z(0), w(0) {}
     ...
     */
    template<typename otherType>
    Vector(const Vector<1, otherType>& otherVec, componentType y, componentType z, componentType w) :
        x(static_cast<componentType>(otherVec.x)), y(y), z(z), w(w) {}
    ...
    explicit Vector(const Vector<2, otherType>& otherVec) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)), z(0), w(0) {}
     ...
     */
    template<typename otherType>
    Vector(const Vector<2, otherType>& otherVec, componentType z, componentType w) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)), z(z), w(w) {}
    ...
    Vector(const Vector<2, otherType>& otherVec, const Vector<2, otherType>& otherVec2) :
        ...
        z(static_cast<componentType>(otherVec2.x)), w(static_cast<componentType>(otherVec2.y)) {}
    ...
    explicit Vector(const Vector<3, otherType>& otherVec) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)),
        z(static_cast<componentType>(otherVec.z)), w(0) {}
    /**
     ...
     */
    template<typename otherType>
    Vector(const Vector<3, otherType>& otherVec, componentType w) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)),
        z(static_cast<componentType>(otherVec.z)), w(w) {}
    ...
    explicit Vector(const Vector<4, otherType>& otherVec) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)),
        z(static_cast<componentType>(otherVec.z)), w(static_cast<componentType>(otherVec.w)) {}
    ...
    explicit Vector(const Vector<otherSize, otherType>& otherVec) :
        ...
        z(static_cast<componentType>(otherVec[2])), w(static_cast<componentType>(otherVec[3])) {}

    /* -------------------------------------------- */

    // Assignment operator
    template<typename otherType>
    Vector& operator=(const Vector<4, otherType>& otherVec);
    ...
    // Add Vector
    template<typename otherType>
    Vector operator+(const Vector<4, otherType>& rhs) const;
    ...
    // Add Vector In-Place
    template<typename otherType>
    Vector& operator+=(const Vector<4, otherType>& rhs);
     ...
     */
    template<typename otherType>
    bool equal(const Vector<4, otherType>& rhs,
