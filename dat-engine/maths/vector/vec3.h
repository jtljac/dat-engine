 ...
 */
struct DatEngine::DatMaths::Vector<3, componentType> {
    ...
    explicit Vector(const Vector<1, otherType>& otherVec) : x(static_cast<componentType>(otherVec.x)), y(0), z(0) {}
     ...
     */
    template<typename otherType>
    Vector(const Vector<1, otherType>& otherVec, componentType y, componentType z) :
        x(static_cast<componentType>(otherVec.x)), y(y), z(z) {}
    ...
    explicit Vector(const Vector<2, otherType>& otherVec) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)), z(0) {}
     ...
     */
    template<typename otherType>
    Vector(const Vector<2, otherType>& otherVec, componentType z) :
        x(static_cast<componentType>(otherVec.x)), y(static_cast<componentType>(otherVec.y)), z(z) {}
    ...
    // Assignment operator
    template<typename otherType>
    Vector& operator=(const Vector<3, otherType>& otherVec);
    ...
    // Add Vector
    template<typename otherType>
    Vector operator+(const Vector<3, otherType>& rhs) const;
    ...
    // Add Vector In-Place
    template<typename otherType>
    Vector& operator+=(const Vector<3, otherType>& rhs);
     ...
     */
    template<typename otherType>
    Vector crossProduct(Vector<3, otherType> otherVec) const;
     ...
     */
    template<typename otherType>
    bool equal(const Vector<3, otherType>& rhs,
