...
namespace DatEngine::DatMaths {
    ...
    Vector<4, componentType> Vector<4, componentType>::operator+(const Vector<4, otherType>& rhs) const {
        return {x + static_cast<componentType>(rhs.x), y + static_cast<componentType>(rhs.y),
                z + static_cast<componentType>(rhs.z), w + static_cast<componentType>(rhs.w)};
    }

    template<typename componentType>
    template<typename otherType>
    Vector<4, componentType> Vector<4, componentType>::operator+(const otherType rhs) const {
        return {x + static_cast<componentType>(rhs), y + static_cast<componentType>(rhs),
                z + static_cast<componentType>(rhs), w + static_cast<componentType>(rhs)};
    }
    ...
    componentType Vector<4, componentType>::dotProduct(Vector<4, otherType> otherVec) const {
        return x * static_cast<componentType>(otherVec.x) + y * static_cast<componentType>(otherVec.y) +
